...
def download_videos():
    """Downloads multiple videos from TikTok

    Args:
        counter (integer): Keeps track of the current file
    """
    ...
    for url in video_urls:
        ...
        try:
            ...
            with open(f"data/temp/videos/raw_videos/video_{idx}.mp4", 'wb') as f:
            ...
            print(f"Video {idx} - Download Completed")
            idx += 1
